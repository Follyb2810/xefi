    ...
    return (
        <Tabs>
            ...
            <TabPanels>
                ...
                <Stack spacing={8}>
                        <Box>
                            <Text color="brand.700">Listing starts on:</Text>
                            <Input
                                placeholder="Select Date and Time"
                                size="md"
                                type="datetime-local"
                            ...
                            />
                            <Text mt={2} color="brand.700">Listing ends on:</Text>
                            <Input
                                placeholder="Select Date and Time"
                                size="md"
                                type="datetime-local"
                        ...
                        <Box>
                            <Text fontWeight={"bold"} color="brand.700">Starting bid from:</Text>
                            <Input
                                placeholder="0"
                                size="md"
                                type="number"
                        ...
                        <Box>
                            <Text fontWeight={"bold"} color="brand.700">Buyout price:</Text>
                            <Input
                                placeholder="0"
                                size="md"
                                type="number"
